...
#define UPDATE_GLOBAL_INT(panel, name, val)                                                                                                  \
    do                                                                                                                                       \
    {                                                                                                                                        \
        ...
        if (_s)                                                                                                                              \
            config_setting_set_int(_s, val);                                                                                                 \
    } while (0)

#define UPDATE_GLOBAL_STRING(panel, name, val)                                                                                               \
    do                                                                                                                                       \
    {                                                                                                                                        \
        config_setting_t *_s = config_setting_add(config_setting_get_elem(config_setting_get_member(config_root_setting(panel->config), ""), \
                                                                          0),                                                                \
        ...
        if (_s)                                                                                                                              \
            config_setting_set_string(_s, val);                                                                                              \
    } while (0)

#define UPDATE_GLOBAL_COLOR(panel, name, val)                                                                                                \
    do                                                                                                                                       \
    {                                                                                                                                        \
        config_setting_t *_s = config_setting_add(config_setting_get_elem(config_setting_get_member(config_root_setting(panel->config), ""), \
                                                                          0),                                                                \
        ...
        {                                                                                                                                    \
            ...
            config_setting_set_string(_s, _c);                                                                                               \
        }                                                                                                                                    \
    } while (0)
                                   ...
                                   gpointer user_data)
{
    ...
    g_object_set(cell, "sensitive", (panel_edge_available(p, p->edge, indices[0] - 1)), NULL);
