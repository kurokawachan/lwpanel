...
{
  if ((p->height_label != NULL) && (p->width_label != NULL) && (p->alignment_left_label != NULL) && (p->alignment_right_label != NULL))
  {
...
static void panel_draw_label_text_with_color(Panel *p, GtkWidget *label, const char *text,
