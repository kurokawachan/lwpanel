...
static GtkWidget *constructor(LXPanel *panel, config_setting_t *settings)
{
  ...
  lx_b->alarmCommand = lx_b->backgroundColor = lx_b->chargingColor1 = lx_b->chargingColor2 = lx_b->dischargingColor1 = lx_b->dischargingColor2 = NULL;
...
static GtkWidget *config(LXPanel *panel, GtkWidget *p)
{
  ...
  return lxpanel_generic_config_dlg(_("Battery Monitor"),
                                    ...
                                    "", panel_config_int_button_new(_("Border width"), (int *)&b->requestedBorder, 0, 6), CONF_TYPE_EXTERNAL,
                                    "", panel_config_int_button_new(C_("Width", "Size"), (int *)&b->thickness, 1, 50), CONF_TYPE_EXTERNAL,
